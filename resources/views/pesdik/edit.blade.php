        ...
        <form action="/pesdik/{{$pesdik->id}}/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{$pesdik->nama}}" name="nama" type="text" class="form-control" id="nama" placeholder="Nama Siswa" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">
                    ...
                    <input value="{{$pesdik->nisn}}" name="nisn" type="number" class="form-control" id="nisn" placeholder="NISN" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" name="foto" class="form-control-file" id="foto" accept="image/*">Foto Harus Berformat Jpeg,Jpg,Png</div>
                </div>
            </div>
            <hr>
            <br>

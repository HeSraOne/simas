                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <img src="/uploads/foto/{{ $pesdik->foto }}" alt="Foto {{$pesdik->nama}}" class="img-thumbnail" width="100"></td>
                                </div>
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b>NISN/Induk</b>
                                        <a class="float-right">{{ $pesdik->induk }}/{{ $pesdik->nisn }}</a>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <div class="active tab-pane" id="keluar">
                                        <form action="/pesdik/{{ $pesdik->id }}/keluar" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="alasan_keluar" class="form-control bg-light" id="alasan_keluar" rows="3" placeholder="Alasan Keluar" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">{{ old('alasan_keluar') }}</textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <hr>
                                    ...
                                    <div class="tab-pane" id="lulus">
                                        <form action="/pesdik/{{ $pesdik->id }}/alumni" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="keterangan" class="form-control bg-light" id="keterangan" rows="3" placeholder="Keterangan" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">{{ old('keterangan') }}</textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            <hr>
